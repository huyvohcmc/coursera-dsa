...
def set_prefs(prefs):
    ...
    # In general case, you don't have to change this value, unless you're an
    # rope expert. Change this value to inject you own implementations of
    # interfaces listed in module
